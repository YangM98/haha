...
def test_methods():
    ...
    out = add_haze(img)
    cv2.imwrite(r"C:\Users\Administrator\Desktop\add_haze.jpg", out)
    out = add_gasuss_noise(img)
    cv2.imwrite(r"C:\Users\Administrator\Desktop\add_gasuss_noise.jpg", out)
    out = add_gasuss_blur(img)
    cv2.imwrite(r"C:\Users\Administrator\Desktop\add_gasuss_blur.jpg", out)
    out = ajust_image(img)
    cv2.imwrite(r"C:\Users\Administrator\Desktop\ajust_image.jpg", out)
    out = ajust_image_hsv(img)
    cv2.imwrite(r"C:\Users\Administrator\Desktop\ajust_image_hsv.jpg", out)
    ajust_jpg_quality(img, save_path=r'C:\Users\Administrator\Desktop\ajust_jpg_quality.jpg')
test_methods()